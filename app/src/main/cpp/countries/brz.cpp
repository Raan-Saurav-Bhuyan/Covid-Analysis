...
bool brazil(void) {
	 ...
	 **/
			...
			string mName, fName;/* String to attach the abbriviation of the name					 *
								 * of the month and the input file.									 *
								 */
	//================================================================================================//
	 ...
	 ** Please put the file inside the '/data/Brazil/' folder.										 **
	 **/
	...
	fName = "data/Brazil/Brazil_data(" + mName + ").csv";
	...
	if (covid.FindInitialGuess(m, k)) {
		...
		string postfix1 = "result/Brazil/logistic_output_Brazil(" + mName + ").txt";
		string csvSave1 = "excel/Brazil/logistic_output_Brazil(" + mName + ").csv";
		...
		string postfix2 = "result/Brazil/logistic_pred_Brazil(" + mName + ").txt";
		string csvSave2 = "excel/Brazil/logistic_pred_Brazil(" + mName + ").csv";
		...
		system("explorer excel\\Brazil\\");		//Opens the folder
		//============================================================================================//
	}
	//================================================================================================//
