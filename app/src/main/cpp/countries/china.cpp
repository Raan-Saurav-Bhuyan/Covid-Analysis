...
bool china(void) {
	...
	fName = "data/China/China_data(" + mName + ").csv";
	...
	if (covid.FindInitialGuess(m, k)) {
		...
		string postfix1 = "result/China/logistic_output_China(" + mName + ").txt";
		string csvSave1 = "excel/China/logistic_output_China(" + mName + ").csv";
		...
		string postfix2 = "result/China/logistic_pred_China(" + mName + ").txt";
		string csvSave2 = "excel/China/logistic_pred_China(" + mName + ").csv";
		...
		system("explorer excel\\China\\");		//Opens the folder
		//============================================================================================//
	}
	//================================================================================================//
