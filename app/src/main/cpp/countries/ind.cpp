...
bool india(void) {
	 ...
	 ** Please put the file inside the '/data/India/' folder.										 **
	 **/
	...
	fName = "data/India/India_data(" + mName + ").csv";
	...
	if (covid.FindInitialGuess(m, k)) {
		...
		string postfix1 = "result/India/logistic_output_India(" + mName + ").txt";
		string csvSave1 = "excel/India/logistic_output_India(" + mName + ").csv";
		...
		string postfix2 = "result/India/logistic_pred_India(" + mName + ").txt";
		string csvSave2 = "excel/India/logistic_pred_India(" + mName + ").csv";
		...
		system("explorer excel\\India\\");		//Opens the folder
		//============================================================================================//
	}
	//================================================================================================//
